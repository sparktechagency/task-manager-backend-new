...
notificationRoutes.get('', (0, auth_1.default)(user_constants_1.USER_ROLE.POSTER, user_constants_1.USER_ROLE.TASKER), notification_controller_1.NotificationController.getAllNotificationByUser);
...
notificationRoutes.delete('/:id', (0, auth_1.default)(user_constants_1.USER_ROLE.POSTER, user_constants_1.USER_ROLE.TASKER), notification_controller_1.NotificationController.deletedNotification);
