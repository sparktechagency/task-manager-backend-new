...
const paypalConformWithdraw = (0, catchAsync_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const { userId } = req.user;
    const withdrawData = req.body;
    withdrawData.taskerUserId = userId;
    const result = yield withdraw_service_1.withdrawService.conformPaypalWithdrawService(withdrawData);
    if (result) {
...
const withdrawRequest = (0, catchAsync_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const { userId } = req.user;
    const withdrawData = req.body;
    withdrawData.taskerUserId = userId;
    const result = yield withdraw_service_1.withdrawService.withdrawRequestService(withdrawData);
    if (result) {
        (0, sendResponse_1.default)(res, {
            statusCode: http_status_1.default.OK,
            success: true,
...
const adminPaidBankWithdraw = (0, catchAsync_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield withdraw_service_1.withdrawService.adminPaidBankWithdrawService(req.params.id);
    if (result) {
        (0, sendResponse_1.default)(res, {
            statusCode: http_status_1.default.OK,
            success: true,
